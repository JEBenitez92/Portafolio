    ...
    <div>
      <div className={Style.contenedorColumnas} >
        ...
        <div className={Style.EnlaceCorreo}>
          <a href="mailto:Jonathan92_24@hotmail.com?subject=Te contacto desde tu portafolio">Mi correo</a>
        </div>
        </div>
        ...
        <div>
          ...
          <div className={Style.contenedorCuerpoCv}>
              ...
              <p>
                ...
                <p>Julio 2014 - Acualidad <br />
                Control de ingreso y egreso de personal, visitas y proveedores. <br />
              ...
              <p>
                ...
                <p>
                  ...
                  Jefe de Equipo, organizacion y capacitacion de soldados junto al jefe de grupo. <br />
                  Auxiliar de sala de armas, encargado de la documentacion y control de inventarios <br />
                  de la sala de armas.
                </p>
              </p>
                <h2>Educacíon</h2>
              <p>
                ...
                <p> Agosto 2022 - Mayo 2023 <br />
                  JavaScript, HTML, CSS, Node, React, Redux, SQL</p>
              </p>
              <p>
                <h4>Universidad Nacional José C Paz</h4>
                <p>Marzo 2019 - Actualidad. <br />
