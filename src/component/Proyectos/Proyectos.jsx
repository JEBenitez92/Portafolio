  ...
  return (
    <div className={Style.contenedorGeneral}>
      <div className={Style.contenedorTitulo}>
        <h1>Te presento mis trabajos</h1>
      </div>
      <div className={Style.contenedorParrafo}>
        <p>
          En este apartado vas a encontrar todos mis proyectos realizados, desde
          el primero, "Rick and Morty", hasta <br />
          los últimos que vaya realizando. <br />
          Vas a observar que el proyecto "Rick and Morty" tiene defectos. No
          olvides que fue el primer proyecto que <br /> armé en mis comienzos en
          esta carrera de programador. Podría corregirlo y dejarlo más
          presentable, pero <br /> decidí dejarlo como me salió en ese momento y
          que sirva para reflejar mi crecimiento personal y profesional.
        </p>
      </div>
      <div className={Style.contenedorProyectos}>
        <div className={Style.proyecto}>
          ...
          <a href="https://proyecto-rick-and-morty-58jctsoie-jebenitez92.vercel.app/">
            Rick and Morty
          </a>
          <p>
            Credenciales <br />
        ...
        <div className={Style.proyecto}>
          ...
          <p>
            ...
            la posibilidad de seleccionar razas favoritas.
            <br />
            Fue creado con React, Redux, JavaScript, NodeJs, Express,
            <br />
            PostgreSQL
          </p>
        </div>
        ...
        <div className={Style.proyecto}>
          ...
          <p>
            ...
            donde se pueden ver diversas marcas y filtrar por talles,
            <br />
            precios, entre otros. Se utiliza Firebase para el inicio
            <br />
            de sesión y MercadoPago como pasarela de pago. <br />
            Fue desarrollado con React, Redux, JavaScript, Node.js,
            <br />
            Express, PostgreSQL,Jsonwebtoken, nodemailer,
            <br />
